...
def reduce_diff(start_date, end_date):
    ...
    for single_date in date_range:
        ...
        col_diff = db_opt_result["REV_" + today_date + "_" + str(abs(the_route_id))]
        
        that_time_stamp = transfer_tools.find_gtfs_time_stamp(single_date)

        rl_diff = list(col_diff.find({"route_id": the_route_id}))
    ...
    db_result_route = db_diff_reduce["RE_" + str(the_route_id)]
