...
db_er = client.cota_er_validation
...
def calculate_diff(single_date):
    ...
    col_pr_opt = db_pr_val["SEP_" + today_date] # PR optimal
    ...
    col_er = db_er["er_min_6_" + today_date] # ER
    ...
    print("start", len(rl_rr), len(rl_pr_opt), len(rl_ar), len(rl_er))
    ...
    print("end", len(rl_rr), len(rl_pr_opt), len(rl_ar), len(rl_er))
