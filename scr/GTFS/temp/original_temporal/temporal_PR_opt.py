    ...
    for single_date in date_range:
        ...
        for each_record in rl_opt_result:
            for i in range(10):
                ...
                if type(time_gr_alt) is int and type(time_gr_arr) is int and time_gr_alt != 0 and time_gr_arr != 0 time_gr_alt != 9999999999 and  time_gr_alt != 9999999999:
        ...
        # print(today_date,large_count, wt_gr[0], wt_gr[1],wt_gr[2],wt_gr[3],wt_gr[4],wt_gr[5],wt_gr[6],wt_gr[7],wt_gr[8],wt_gr[9],)
