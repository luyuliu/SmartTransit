...
def analyze_transfer(single_date):
    ...
    col_pr_opt_result = db_opt_result[today_date+"_test"]
    pre_count = col_pr_opt_result.estimated_document_count()
    count = db_smart_transit[today_date+"_0_test"].estimated_document_count()
    ...
    for each_buffer in insurance_buffers:
        db_today_smart_transit = db_smart_transit[today_date+"_"+str(each_buffer)+"_test"]
