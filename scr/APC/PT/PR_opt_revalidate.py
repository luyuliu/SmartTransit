...
db_opt_finalization = client.cota_apc_pr_opt
...
def validate_stop_time(single_date):
    ...
    col_opt_result = db_opt_finalization["FIN_" + today_date] # Finalized
    col_smart_transit = db_opt_result["REV_" + today_date] # Revalidation
