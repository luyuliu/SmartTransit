...
def analyze_transfer(memory):
    ...
    if wt_er_count != 0:
        print("Final - ",memory , (wt_er_val/wt_er_count)**(1/2), wt_er_count)
        return (wt_er_val/wt_er_count)**(1/2)
    else:
        print("Final - ",memory, 0)
        return 0
