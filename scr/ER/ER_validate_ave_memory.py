...
db_er_opt = client.cota_er_optimization
...
def validate_er(single_date, memory):
    ...
    if (start_date_p - date(2018, 2, 1)).total_seconds() < 0:
        return False
    col_er = db_er_opt["er_ave_" +
    ...
    col_er_val = db_er_val["er_ave_" + str(memory) + "_" + today_date]
    ...
    for each_record in rl_real_time:
        ...
        alt_cal_rl = transfer_tools.find_alt_time(
            each_record["time_er_arr"], route_id, stop_id, today_date, criteria)
